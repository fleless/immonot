...
class SearchAnnoncesRepository {
  ...
  Future<SearchResponse> searchAnnonces(int pageId, SearchRequest request, String sort) {
  ...
  Future<String> contactAnnonce(String oidAnnonce, String nom, String prenom,
    ...
    return _apiProvider.contactAnnonce(oidAnnonce, nom, prenom, phone, email, message);
  }
}
